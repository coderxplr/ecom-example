                ...
                <nav className="hidden md:flex space-x-10">
                    {menuItems.map((item, index) => (
                        <React.Fragment key={index}>
                            {item.dropdown ? (
                                <Dropdown overlay={naturalStonesMenu} trigger={['hover']} className='border-gold-700'>
                                    <a href={item.href} className="nav-link text-xl text-gray-500" style={{ fontFamily: 'lexand' }}>
                            ...
                            {item.dropdown ? (
                                <>
                                    ...
                                    >
                                        ...
                                        <span className={`dropdown-indicator ${mobileDropdownOpen ? 'transform rotate-180' : ''} text-gold-700`}>▼</span>
                                    </div>
                                    {mobileDropdownOpen && (
                                ...
                                <a href={item.href} className="block p-4 text-lg">{item.label}</a>
                            )}
                        </div>
                    ))}
