...
const Contact = () => {
  ...
  const handleSendEmail = () => {
    const mailTo = `mailto:acenaturalstones@gmail.com?subject=${encodeURIComponent(
  ...
  return (
    <div
      className="flex flex-col items-center bg-white p-4 sm:p-6 lg:p-8"
      ...
      <div className="w-full bg-white rounded-lg p-6 sm:p-8 lg:p-12 text-left">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg sm:text-xl text-black mb-4">
            We're passionate about helping you find the perfect natural stone
            for your project. Reach out to us today and let's bring your vision
            to life!
          </p>
        </div>
        ...
        <div className="mb-8 w-[80%]">
          ...
          <p className="text-lg sm:text-xl text-black mb-4">
            Please leave your full name & contact details, along with a little
            bit about your project and what you are looking for, so a team
            member can call you back at earliest.
          </p>
          <form
            onSubmit={(e) => {
              e.preventDefault();
          ...
          >
            <div>
              <label
                className="block text-lg sm:text-xl font-semibold text-black mb-2"
                htmlFor="name"
              >
                Name:
              </label>
        ...
        <div className="mb-8">
          ...
          <a
            ...
            className="flex flex-col text-lg sm:text-xl text-black"
          >
            <img
        ...
        <div className="mb-8">
          ...
          <p className="text-lg sm:text-xl text-black mb-4">
            Join our community and stay up-to-date on the latest news, trends,
            and promotions:
          </p>
